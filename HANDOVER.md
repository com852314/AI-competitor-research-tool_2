...
- ✅ W4 快照（2026-05-28）：5 平台 Top 20 + TCG/BAJI 新遊戲；踩坑：BAJI newGames gameId 全空（已知問題）
...
下一步是 **W5 抓取**（按第 10 節 SOP v5 執行）。

---

## 4. 當前正在處理的問題

無。W4 已完工並 push（2026-05-29）。
...
4. **不要重做已完成的事**：W1–W4 已抓、Phase 2D/2E 已完成
5. **跟用戶確認現在要做什麼**：下一週 W5 抓取？還是 viewer 新功能？
